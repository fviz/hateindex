...
$(document).ready(function () {
    var heatmapData = [new google.maps.LatLng(37.782, -122.447), new google.maps.LatLng(37.782, -122.445), new google.maps.LatLng(37.782, -122.443)];
    ...
    $.getJSON("./data/geopreview.json", function (data) {
        console.log("AAA");
        console.log(getLatLong(data));
    });

    function getLatLong(data) {
        var heatmapdataprocessed = [];
        $.each(data, function () {
            var counter = 0;
            var longitude = "";
            var latitude = "";
            ...
            heatmapdataprocessed.push(c);
            return heatmapdataprocessed;
        });
    }
});
